function [nn,gam_val,w_est] = samp_sz(four_coef,Gam_vec,w_vec,s_vec,s_max,p_val,eps,C,n0,nm_flg,w_flg,w_ini)
    ...
    elseif (w_flg) %do if we know weights (but not norm)...
        ...
        %Sample exact coefficients for 1-d weights (up to n0 smoothness)
